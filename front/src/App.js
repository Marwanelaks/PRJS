...
function App() {
  ...
  return (
    <>
    <Navbar/>
  <div className=' container selright'>
    <select className='cls' onChange={handleLang} >
    ...
    <div className='container-fluid'>
      <div className='row'>
      <h1 id='traiteuref' className='text-danger text-center'>Traiteur</h1>
      </div>
...
كيو أوفيسيا ديسيريونتموليت انيم أيدي ايست لابوريوم 
  ...
  <button className='btn btn-success rounded' onClick={()=>navigate("/Rendez-Vous") }>Rendez-Vous</button>
</div>
</div>
<FaqPage/>
<Footer/>
